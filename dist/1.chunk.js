...
var CourseDetailStaffComponent = (function () {
    function CourseDetailStaffComponent(route, studentService, router, appService, courseService, attendanceService, scheduleService, authService, excelService) {
        this.route = route;
    ...
    CourseDetailStaffComponent.prototype.getAttendanceList = function () {
        ...
        this.attendanceService.getAttendanceListByCourse(this.course_id, classes_id).subscribe(function (result) {
            _this.apiResult = result.result;
    ...
    CourseDetailStaffComponent.prototype.onSaveEditAttendance = function () {
        ...
        this.attendanceService.updateAttendanceListByCourse(this.course_id, classes_id, this.temp_attendance_lists)
            ...
            _this.resultMessageModal.onOpenModal();
            _this.appService.showPNotify(_this.apiResult, _this.apiResultMessage, _this.apiResult === 'success' ? 'success' : 'error');
    ...
    CourseDetailStaffComponent.prototype.onAddToAttendanceList = function () {
        var _this = this;
        this.attendanceService.checkAddToCourse(this.course_id, this.new_code, this.new_name).subscribe(function (results) {
            if (results.result === 'success') {
                var attendance = {
                    id: 0,
                    code: _this.new_code,
    ...
    CourseDetailStaffComponent.prototype.onRemoveFromAttendanceList = function () {
